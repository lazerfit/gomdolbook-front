...
export const MOCK_SERVER_READING_STATUS_RESPONSE = (server: SetupServer, isbn: string) => {
  server.use(
    http.get(`${apiBaseUrl}/v1/status/${isbn}`, () => {
...
export const MOCK_SERVER_COLLECTION_DETAIL_DELETE = (server: SetupServer, name: string) => {
  server.use(
...
export const MOCK_SERVER_IS_EXIST_BOOK_IN_COLLECTION = (server: SetupServer, isbn: string, name: string) => {
  server.use(
...
export const MOCK_SERVER_REMOVE_BOOK_FROM_COLLECTION = (server: SetupServer, isbn: string, name: string) => {
  server.use(
